...
class TestEntropyProof:
    ...
    def test_algorithm_options(self):
        ...
        proof = EntropyProof(seed_hash="def456", algorithm="rejection_sampling")
...
class TestCostEstimate:
    ...
    def test_requires_feature_name(self):
        ...
        estimate = CostEstimate(estimated_usd=0.01, feature_name="oracle_query")
...
class TestModelSerialization:
    ...
    def test_cost_estimate_round_trip(self):
        ...
        original = CostEstimate(
            estimated_usd=0.05, feature_name="oracle", can_proceed=True
        )
        json_str = original.model_dump_json()
